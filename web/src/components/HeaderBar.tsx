        ...
        {mobileMenuOpen && (
          ...
          >
            ...
            <motion.div
              ...
              className="flex flex-col h-[calc(100vh-64px)] overflow-y-auto px-6 py-6 bg-nofx-bg-lighter/95 border-t border-white/5"
            >
              {/* Nav Tabs */}
              ...
              <div className="mt-8 pt-6 border-t border-white/10 flex flex-col gap-4">
                ...
                {isLoggedIn && user ? (
                  <div className="flex items-center justify-between gap-3">
                    <div className="flex items-center gap-3">
                      <div className="w-8 h-8 rounded-full flex items-center justify-center text-xs font-bold bg-nofx-gold text-black">
                        {user.email[0].toUpperCase()}
                      </div>
                      <div className="text-sm text-nofx-text-muted truncate">
                        {user.email}
                      </div>
                    </div>
                    ...
                    {onLogout && (
                      <button
                        ...
                        className="px-3 py-2 rounded font-semibold text-sm bg-nofx-danger/20 text-nofx-danger hover:opacity-90"
                      >
                        {t('exitLogin', language)}
                      </button>
                    )}
                  ...
                  currentPage !== 'register' && (
                    <div className="flex gap-3">
                      <a
                        ...
                        className="flex-1 text-center px-3 py-2 rounded font-semibold text-sm text-nofx-text-muted hover:text-white hover:bg-white/5"
                      >
                        {t('signIn', language)}
                      </a>
                      {registrationEnabled && (
                        <a
                          href="/register"
                          onClick={() => setMobileMenuOpen(false)}
                          className="flex-1 text-center px-3 py-2 rounded font-semibold text-sm bg-nofx-gold text-black hover:opacity-90"
                        >
                          {t('signUp', language)}
                        </a>
                      )}
